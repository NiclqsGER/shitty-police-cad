            <?php 
            if(!$_SESSION['power'] >= 5) {
                header('location: index.php?p=interface&c=neuigkeiten');
            exit;
            } ?>
            ...
            <?php 
                ...
                if(isset($_POST['submit'])) {
                    ...
                    $stmt = $mysql->prepare("INSERT INTO neuigkeiten (TITLE, NEWS, CREATED_AT, CREATOR_ID, CREATOR_NAME) VALUES (:title, :news, :created_at, :creator_id, :creator_name);");
